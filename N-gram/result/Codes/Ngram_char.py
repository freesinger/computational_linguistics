...
rootdir = '/Users/shanewang/Desktop/nlp2'
newdir = '/Users/shanewang/Desktop/preprc2'
train_dir= '/Users/shanewang/Desktop/preprc2/train'
test_dir= '/Users/shanewang/Desktop/preprc2/test'
valid_dir= '/Users/shanewang/Desktop/preprc2/valid'
...
def sentenceSplit(sentence):
    sym = sentence.split('  ')
    res = sym[0] + '  '
    for elem in sym[1: len(sym) - 2]:
        words = elem.split('/')
        for char in words[0]:
            res = res + char + '  '
    res = res + sym[len(sym) - 2] + '\n'
    return res
...
if __name__ == '__main__':
    ...
    sentence_Perplexity(valid_dir,"1a.txt")
    sentence_Perplexity(test_dir,"1a.txt")
    ...
    sentence_bi_Perplexity(valid_dir,"1a.txt")
    sentence_bi_Perplexity(test_dir,"1a.txt")
    ...
    gt_sentence_Perplexity(valid_dir,"2a.txt",c_times)
    gt_sentence_Perplexity(test_dir,"2a.txt",c_times)
    ...
    gt_sentence_bi_Perplexity(valid_dir,"2a.txt",c_times)
    gt_sentence_bi_Perplexity(test_dir,"2a.txt",c_times)
